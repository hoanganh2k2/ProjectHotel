<%-- 
    Document   : Signup
    Created on : May 20, 2023, 9:10:28 PM
                    ...
                    <div class="signup-form">
                        ...
                        <form action="signup" method="POST" class="register-form" id="register-form">
                            ...
                            <div class="form-group">
                                ...
                                <label for="agree-term" class="label-agree-term"><span><span></span></span>I agree all statements in  <a href="about" class="term-service">Terms of service</a></label>
                            </div>
